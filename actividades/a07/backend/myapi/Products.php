...
class Products extends DataBase {
    ...
    public function __construct(string $db, string $user = 'root', string $pass = 'pesadilla123', string $host = 'localhost', int $port = 3307) {

        parent::__construct($db, $user, $pass, $host, $port);
